...
//let populationSize = 10; // Ukuran populasi awal
...
function draw() {
  ...
  text("By : ",10,1900)
  text("1. Ahmad Fauzi", 10,1930)
  text("2. Shakila Syafa Triana", 10,1960)
  text("3. Tia Anezka Laetisia", 10,1990)
  text("4. Adilla Anisa Fitri", 10,2020)
  text("5. Ananda Nadira Sabrina", 10,2050)
  text("6. Yuyun Wijayani", 10,2080)
  text("7. Lidya Maria Octafia", 10,2110)
  
  
  text("NIM",400,1900)
  text("121160058",400,1930)
  text("121160017",400,1960)
  text("121160018",400,1990)
  text("121160034",400,2020)
  text("121160096",400,2050)
  text("121160084",400,2080)
  text("119160064",400,2110)
